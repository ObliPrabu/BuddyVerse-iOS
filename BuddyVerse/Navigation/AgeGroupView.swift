...
/// button - shown right after picking a mood, asks whether content should
/// be written for a kid or an adult.
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                Button {
                    router.push(.aiGenerating(gameType: gameType, mood: mood, ageGroup: "KID"))
                } label: {
                    Text("Kid 🧒")
                        .font(.system(size: 16))
                        .foregroundColor(.white)
                ...
                Button {
                    router.push(.aiGenerating(gameType: gameType, mood: mood, ageGroup: "ADULT"))
                } label: {
                    Text("Adult 🧑")
                        .font(.system(size: 16))
                        .foregroundColor(.white)
